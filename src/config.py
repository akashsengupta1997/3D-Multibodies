...
J_REGRESSOR_EXTRA = join(BASE_FOLDER,'data/J_regressor_extra.npy')
COCOPLUS_REGRESSOR = join(BASE_FOLDER,'data/cocoplus_regressor.npy')
H36M_REGRESSOR = join(BASE_FOLDER,'data/J_regressor_h36m.npy')
